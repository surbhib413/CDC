...
import styles from "./BuAtfMap.module.scss";
import GoogleMap from "./BuAtfGoogleMap/index";
import dropdownArrows from "../../assets/images/dropdownArrows.png";
import { Dropdown } from "react-bootstrap";
import { toTitleCase } from "../../utility/utility";


function BuAtfMapContainer(props) {
  useEffect(() => {
    props.handleRegionDropdown("all regions", { lat: 18, lng: 80 }, 5.5)
    // return () => {
    //   cleanup
    // }
...
export default BuAtfMapContainer