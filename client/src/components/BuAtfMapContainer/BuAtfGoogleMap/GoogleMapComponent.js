...
import BuAtfMapTable from "../BuAtfMapTable/BuAtfMapTable"
...
class GoogleMapComponent extends Component {
  ...
  componentDidMount() {
    let url = `${environment.BU_KPI_URL}/overall/data?data_type=ytm&level=region&business_unit=atf`;
    ...
    return (
      this.state.loading
        ...
        >
          ...
          {
            (this.props.mapOf === "all regions" && this.props.activeTab === "atf_tab")
              ?
              ...
              :
              this.props.activeTab === "atf_tab" && <StateMap
