...
class GoogleMapComponent extends Component {
  ...
  componentDidMount() {
    let url = `${environment.BU_KPI_URL}/overall/data?data_type=ytm&level=region&business_unit=inc`;
      ...
      this.state.loading
        ...
        >
          <div className={`${styles.mapKpiSelectorContainer}`}>
            ...
            <div onClick={() => this.onKpiTabChange("terminal")} className={`d-flex align-items-center justify-content-center flex-column ${styles.mapKpiSelector} ${this.state.activeKpi === "terminal" ? styles.active : ""}`}>TERMINAL</div>
          </div>
          ...
          <div className={`${styles.mapTableContainer}`}>
            <BuIncMapTable activeKpi={this.state.activeKpi}></BuIncMapTable>
          </div>
          {
            (this.props.mapOf === "all regions" && this.props.activeTab === "inc_tab")
              ?
              ...
              :
              this.props.activeTab === "inc_tab" && <StateMap
