...
function BuLubesSalesRevenue(props) {
  ...
  useEffect(() => {
    function prepareGraphData(kpi_name) {
      let url = `${environment.BU_KPI_URL}/data?business_unit=lubes&kpi_name=${kpi_name}&data_type=ytm&level=country`;
...
export default BuLubesSalesRevenue;