...
import BuLubesMarketShareGraph from "./BuLubesMarketShareGraph";
import styles from "./BuLubesMarketShare.module.scss";
import { Spinner } from "react-bootstrap";
import environment from "../../../environment";

function BuLubesMarketShare(props) {
  ...
  useEffect(() => {
    function prepareGraphData() {
      let url = `${environment.BU_KPI_URL}/market/data?data_type=ytm&level=country&business_unit=lubes`;
  ...
  return (
    <div className={`${styles.BuMarketShareContainer}`}>
      ...
      <div className={`d-flex  ${styles.graphContainer}`}>
        {
          graphData ?
            <BuLubesMarketShareGraph graphData={graphData}></BuLubesMarketShareGraph>
            :
...
export default BuLubesMarketShare;