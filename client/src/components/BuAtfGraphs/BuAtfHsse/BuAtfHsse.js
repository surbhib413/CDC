...
import styles from "./BuAtfHsse.module.scss";
...
function BuAtfHsse() {
  ...
  const prepareData = () => {
    let url = `${environment.BU_KPI_URL}/others/data?data_type=ytm&level=country&business_unit=atf&kpi_type=hsse`;
